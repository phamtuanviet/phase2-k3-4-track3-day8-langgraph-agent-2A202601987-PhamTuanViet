...
def test_metric_from_state_success() -> None:
    state = {
        ...
        "route": "simple",
        "final_answer": "ok",
        "events": [make_event("intake", "completed", "ok"), make_event("answer", "completed", "ok")],  # noqa: E501
        "errors": [],
        "approval": None,
    }
...
def test_summarize_metrics() -> None:
    m1 = metric_from_state(
        {"scenario_id": "1", "route": "simple", "final_answer": "ok", "events": [], "errors": [], "approval": None},  # noqa: E501
        "simple",
        False,
    )
    m2 = metric_from_state(
        {"scenario_id": "2", "route": "tool", "final_answer": None, "events": [], "errors": [], "approval": None},  # noqa: E501
        "tool",
        False,
    )
